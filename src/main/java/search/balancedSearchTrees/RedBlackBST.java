...
class RedBlackBST<Key extends Comparable<Key>, Value> {
	...
	private Node invFlip(Node n) {
		if (isRed(n.left) || isRed(n.right)) 
			throw new IllegalArgumentException("inv flip only when both children are black");
	...
	public static void main(String[] args) {
		...
		rbt.put(new Character('L'), new Integer(11));
		rbt.delMin();
		assert rbt.get(new Character('A')) == null : "deleted key should return null";
		assert rbt.get(new Character('H')).equals(new Integer(6)) : "get should get the right value";
		assert rbt.get(new Character('P')).equals(new Integer(10)) : "get should get the right value";
		rbt.put(new Character('R'), new Integer(44));
		assert rbt.get(new Character('R')).equals(new Integer(44)) : "get should get the updated value";
		assert rbt.get(new Character('C')).equals(new Integer(5)) : "get should get the right value";
		rbt.delMin();
		assert rbt.get(new Character('C')) == null : "deleted key should return null";
	}
